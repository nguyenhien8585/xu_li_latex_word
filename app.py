...
def convert_latex_symbols(text):
    ...
    # Xử lý prime notation trước tiên - cách đơn giản và chính xác hơn
    # Pattern: letter^{prime} -> letter'
    prime_pattern = r'([A-Za-z]+)\^\{prime\}'
    result = re.sub(prime_pattern, r"\1'", result)
